...
`},ve=g({__name:"form-validation",setup(R){return(w,c)=>{const F=Q,p=G,m=K,f=H;return A(),P(T,null,{default:o(()=>[l(d,{cols:"12"},{default:o(()=>[l(p,{title:"Simple Form Validation",code:e(W)},{default:o(()=>[c[0]||(c[0]=L("p",null,[y("Use "),L("code",null,"Rules"),y(" prop to validate the input.")],-1)),l(F)]),_:1,__:[0]},8,["code"])]),_:1}),l(d,{cols:"12"},{default:o(()=>[l(p,{title:"Validating Multiple Rules",code:e(X)},{default:o(()=>[l(m)]),_:1},8,["code"])]),_:1}),l(d,{cols:"12"},{default:o(()=>[l(p,{title:"Validation Types",code:e(Z)},{default:o(()=>[l(f)]),_:1},8,["code"])]),_:1})]),_:1})}}});export{ve as default};
