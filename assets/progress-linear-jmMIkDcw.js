import{_}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{c as g,o as m,b as e,b1 as s,d as y,r as f,aQ as V,m as n,f as t,e as o,v as P,g as L,D as k,bp as $,w as M,t as l}from"./index-S43cw9oA.js";import{_ as x}from"./AppCardCode.vue_vue_type_style_index_0_lang-BNkMJjB9.js";import{V as D,a as v}from"./VRow-fWKubFJU.js";import"@vueuse/core";import"./vue3-perfect-scrollbar-o7s4-CP5.js";import"./VCard-CO8V5xCG.js";import"./VAvatar-BblF4_hD.js";import"./VImg-ULZRPAmZ.js";import"./VCardText-C2EK2BY0.js";import"./VDivider-64nIFpK2.js";/* empty css              */const I={},U={class:"demo-space-y"};function T(p,a){return m(),g("div",U,[e(s,{color:"rgb(var(--v-theme-primary))","model-value":"75",striped:""}),e(s,{color:"rgb(var(--v-theme-success))","model-value":"55",striped:""}),e(s,{color:"rgb(var(--v-theme-warning))","model-value":"35",striped:""})])}const j=_(I,[["render",T]]),C={class:"demo-space-y"},R=y({__name:"DemoProgressLinearSlots",setup(p){const a=f(20),r=f(33),u=f(78);return(i,c)=>(m(),g("div",C,[e(s,{modelValue:n(u),"onUpdate:modelValue":c[0]||(c[0]=d=>V(u)?u.value=d:null),color:"primary",height:"8"},null,8,["modelValue"]),e(s,{modelValue:n(a),"onUpdate:modelValue":c[1]||(c[1]=d=>V(a)?a.value=d:null),color:"primary",height:"20"},{default:t(({value:d})=>[o("span",null,P(Math.ceil(d))+"%",1)]),_:1},8,["modelValue"]),e(s,{modelValue:n(r),"onUpdate:modelValue":c[2]||(c[2]=d=>V(r)?r.value=d:null),height:"20",color:"primary"},{default:t(()=>[o("span",null,P(Math.ceil(n(r)))+"%",1)]),_:1},8,["modelValue"])]))}}),S={},N={class:"demo-space-y"};function Y(p,a){return m(),g("div",N,[e(s,{"model-value":"78",height:"8",color:"primary",rounded:!1}),e(s,{"model-value":"20",color:"primary",height:"20",rounded:!1}),e(s,{"model-value":"33",height:"20",color:"primary",rounded:!1})])}const A=_(S,[["render",Y]]),E={};function Q(p,a){return m(),L(s,{color:"primary",indeterminate:"",reverse:""})}const q=_(E,[["render",Q]]),z={};function F(p,a){return m(),L(s,{indeterminate:"",color:"primary"})}const G=_(z,[["render",F]]),H={class:"demo-space-y"},J=y({__name:"DemoProgressLinearBuffering",setup(p){const a=f(10),r=f(20),u=f(),i=()=>{clearInterval(u.value),u.value=setInterval(()=>{a.value+=Math.random()*10+5,r.value+=Math.random()*10+6},2e3)};return k(i),$(()=>{clearInterval(u.value)}),M(a,()=>{if(a.value<100)return!1;a.value=0,r.value=10,i()}),(c,d)=>(m(),g("div",H,[e(s,{modelValue:n(a),"onUpdate:modelValue":d[0]||(d[0]=h=>V(a)?a.value=h:null),color:"primary","buffer-value":n(r)},null,8,["modelValue","buffer-value"])]))}}),K={},O={class:"demo-space-y"};function W(p,a){return m(),g("div",O,[e(s,{"model-value":"15",color:"primary"}),e(s,{"model-value":"30",color:"secondary"}),e(s,{"model-value":"45",color:"success"})])}const X=_(K,[["render",W]]),Z={ts:`<script setup lang="ts">
